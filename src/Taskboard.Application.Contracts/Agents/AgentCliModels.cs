...
{
    private sealed record Entry(string Flag, string Lite, string Normal, string Ultra);
    ...
    private static readonly Dictionary<AgentType, Entry> Entries = new()
    {
        ...
        [AgentType.Kimi] = new("--model", "kimi-k2", "kimi-k2", "kimi-k2-max"), // validate
        [AgentType.Grok] = new("--model", "grok-4-fast", "grok-4", "grok-4-heavy"), // validate
        [AgentType.Aider] = new("--model", "deepseek", "sonnet", "opus"), // validate
        [AgentType.Copilot] = new("--model", "claude-haiku-4-5", "claude-sonnet-4-5", "gpt-5.1"), // validate
        [AgentType.Qwen] = new("-m", "qwen3-coder-flash", "qwen3-coder-plus", "qwen3-max"), // validate
